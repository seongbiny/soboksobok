...
import com.soboksobok.soboksobok.oauth.token.AuthToken;
import com.soboksobok.soboksobok.oauth.token.AuthTokenProvider;
import com.soboksobok.soboksobok.utils.CookieUtil;
...
import static com.soboksobok.soboksobok.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.soboksobok.soboksobok.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected void clearAuthenticationAttributes(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("OAuth2AuthenticationSuccessHandler - clearAuthenticationAttributes");
        super.clearAuthenticationAttributes(request);
        authorizationRequestRepository.removeAuthorizationRequestCookies(request, response);
    }

    private boolean hasAuthority(Collection<? extends GrantedAuthority> authorities, String authority) {
        System.out.println("OAuth2AuthenticationSuccessHandler - hasAuthority");
        if (authorities == null) {
            return false;
        }
    ...
    private boolean isAuthorizedRedirectUri(String uri) {
        System.out.println("OAuth2AuthenticationSuccessHandler - isAuthorizedRedirectUri");
