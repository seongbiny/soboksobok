...
urlpatterns = [
    ...
    path('welfare_word_detail',soboksobok_app2.views.welfare_word_detail,name='welfare_word_detail'),
    path('welfare_detail', soboksobok_app2.views.welfare_detail, name='welfare_detail'),
